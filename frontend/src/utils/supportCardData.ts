...
export const SUPPORT_CARD_DICT: Record<string, SupportCard> = {
    ...
    'air-shakur-speed':         { id: 'air-shakur-speed',         name: 'Air Shakur',         cardName: 'Mag!c Number',                                               type: 'speed',   rarity: 'SSR' },
    ...
    'sirius-symboli-wit':   { id: 'sirius-symboli-wit',   name: 'Sirius Symboli',     cardName: 'Escorte Étoile',                                              type: 'wit', rarity: 'SSR' },
    ...
    'symboli-rudolf-stamina':        { id: 'symboli-rudolf-stamina',        name: 'Symboli Rudolf',        cardName: 'Enchaînement',                                            type: 'stamina',   rarity: 'SSR' },
