...
<!--          <Migrate></Migrate>-->
    ...
    <div v-if="isSuperAdmin"
      ...
      <button
          ...
          class="bg-cyber-glow/40 w-0.5 hover:bg-cyber-glow/70 text-white p-2 rounded-r-md flex items-center justify-center group">
    ...
    <footer class="border-t border-cyber-border/30 bg-cyber-dark/60 py-8 mt-auto">
      <div class="max-w-[1800px] mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
        <div class="text-xs font-mono text-slate-600 flex items-center gap-3 flex-wrap">
          <span>
            Powered by <span class="text-cyber-glow/60 font-bold">Vue</span> & <span class="text-amber-500/60 font-bold">Firebase</span>
          </span>
          <span class="text-slate-700">|</span>
          <a href="https://github.com/darkred1145/raggooner-open" target="_blank" rel="noopener noreferrer"
             class="flex items-center gap-1 text-slate-500 hover:text-white transition-colors">
        ...
        <div class="text-sm text-slate-400 flex items-center gap-4 flex-wrap">
          <span class="flex items-center gap-1.5">
            Original by
            <a href="https://discord.com/users/131446525585784832" target="_blank" rel="noopener noreferrer" class="font-bold text-cyber-purple/60 hover:text-white transition-colors flex items-center gap-1.5 group">
              Sumpfranze <i class="ph-fill ph-discord-logo text-lg"></i>
            </a>
          </span>
          <span class="text-slate-700">|</span>
          <span class="flex items-center gap-1.5">
            Fork by
            <a href="https://discord.com/users/925673287974027324" target="_blank" rel="noopener noreferrer" class="font-bold text-cyber-glow/60 hover:text-white transition-colors flex items-center gap-1.5 group">
              Kenesu <i class="ph-fill ph-discord-logo text-lg"></i>
            </a>
          </span>
        </div>
      </div>
