...
import { useProjectedProgression } from './useProjectedProgression';
import {
    arrayRemove,
    arrayUnion,
...
export function useGameLogic(
    ...
    const projectedProgression = useProjectedProgression(tournament, sortedTeamsA, sortedTeamsB, sortedTeamsC);
